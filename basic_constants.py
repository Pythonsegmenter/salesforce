...
selection_list = ['Account','Contact','Opportunity','Quote','Order','Price Book','Custom Price Book','Contract','Asset','Subscription','Product','Case','Invoice','Entitlement'] #Search for relations in between the objects in this list
